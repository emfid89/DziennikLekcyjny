...
-- -----------------------------------------------------
-- Table `kamilpomyk_baza`.`message_text`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kamilpomyk_baza`.`message_text` ;

CREATE  TABLE IF NOT EXISTS `kamilpomyk_baza`.`message_text` (
  `id` INT NOT NULL ,
  `text` BLOB NOT NULL ,
  PRIMARY KEY (`id`) )
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamilpomyk_baza`.`message`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kamilpomyk_baza`.`message` ;

CREATE  TABLE IF NOT EXISTS `kamilpomyk_baza`.`message` (
  `id` INT NOT NULL ,
  `date` INT NOT NULL ,
  ...
  INDEX `recipient_id` (`recipient_id` ASC) ,
  INDEX `text_id` (`text_id` ASC) ,
  CONSTRAINT 
  ...
  CONSTRAINT 
    FOREIGN KEY (`text_id` )
    REFERENCES `kamilpomyk_baza`.`message_text` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamilpomyk_baza`.`person_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kamilpomyk_baza`.`person_type` ;

CREATE  TABLE IF NOT EXISTS `kamilpomyk_baza`.`person_type` (
  `person_id` INT NOT NULL ,
  `type` ENUM('T', 'S', 'E', 'G') NOT NULL ,
  INDEX `person_id` (`person_id` ASC) ,
  CONSTRAINT 
    FOREIGN KEY (`person_id` )
    REFERENCES `kamilpomyk_baza`.`person` (`id` )
...
-- -----------------------------------------------------
-- Table `kamilpomyk_baza`.`guardian`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kamilpomyk_baza`.`guardian` ;

CREATE  TABLE IF NOT EXISTS `kamilpomyk_baza`.`guardian` (
  `id` INT NOT NULL ,
  `person_id` INT NOT NULL ,
  PRIMARY KEY (`id`) ,
  INDEX `person_id` (`person_id` ASC) ,
...
-- -----------------------------------------------------
-- Table `kamilpomyk_baza`.`student_guardian`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kamilpomyk_baza`.`student_guardian` ;

CREATE  TABLE IF NOT EXISTS `kamilpomyk_baza`.`student_guardian` (
  `student_id` INT NOT NULL ,
  ...
  CONSTRAINT
    ...
    REFERENCES `kamilpomyk_baza`.`guardian` (`id` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
